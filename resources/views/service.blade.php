...
<body class="bg-white">
    ...
    <!-- Section About -->
    <section id="about" class="py-20 bg-indigo-500 relative">
        <div class="container mx-auto text-center mt-20">
            <h2 class="text-5xl text-white font-bold mb-10 uppercase">Jasa Pembuatan Website <br> Profesional</h2>
            <p class="text-lg text-white mb-4">
                Spesialis Jasa Pembuatan Website Profesional, Kami menerima Pembuatan Website untuk <br>Kebutuhan
                Industri Serta siap Melayani Iklan Google
            </p>
        </div>

        <div class="bg-indigo-500 py-24 sm:py-32">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <dl class="grid grid-cols-1 gap-x-8 gap-y-16 text-center lg:grid-cols-3">
                    <div class="mx-auto flex max-w-xs flex-col gap-y-4 opacity-0 transition-opacity duration-1000">
                        <dt class="text-base font-bold text-white">Transactions every 24 hours</dt>
                        <dd class="order-first text-3xl font-bold tracking-tight text-white sm:text-5xl mt-[-15px]">
                            44 million</dd>
                    </div>
                    <div class="mx-auto flex max-w-xs flex-col gap-y-4 opacity-0 transition-opacity duration-1000">
                        <dt class="text-base font-bold text-white">Assets under holding</dt>
                        <dd class="order-first text-3xl font-bold tracking-tight text-white sm:text-5xl mt-[-15px]">
                            $119 trillion</dd>
                    </div>
                    <div class="mx-auto flex max-w-xs flex-col gap-y-4 opacity-0 transition-opacity duration-1000">
                        <dt class="text-base font-bold text-white">New users annually</dt>
                        <dd class="order-first text-3xl font-bold tracking-tight text-white sm:text-5xl mt-[-15px]">
                            46,000</dd>
                    </div>
                </dl>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto flex flex-col lg:flex-row items-center">
            <!-- Konten Teks -->
            <div class="w-full lg:w-1/2 text-left lg:pr-8  opacity-0 transition-opacity duration-1000" >
                <span
                    class="inline-block bg-gray-200 text-sm font-bold text-gray-800 py-1 px-3 mb-4 rounded-full uppercase">
                    sudah saatnya
                </span>
                <h1 class="text-4xl font-extrabold text-indigo-700 leading-tight mb-4 uppercase">
                    Bisnis kamu punya <br />
                    <span class="text-indigo-500 uppercase">Website Berkelas</span>
                </h1>
                ...
                <!-- Tombol Hubungi Kami -->
                <div class="mt-6  opacity-0 transition-opacity duration-1000">
            ...
            <!-- Konten Gambar -->
            <div class="lg:w-1/2 mt-8 lg:mt-0 relative flex justify-end lg:pl-8  opacity-0 transition-opacity duration-1000">
                <div class="p-6 lg:p-12 relative">
                    <!-- Gambar dengan ukuran responsif, w-full di desktop dan setengah lebar di mobile -->
                    <img src="image/icon a 1.png" alt="Tim Jasterweb" class="w-full h-auto object-cover lg:w-full ml-10">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="w-full text-center">
            ...
            <p>Berikut ini sekilas harga untuk Jasa Pembuatan Website. Tersedia paket custom untuk <br> memenuhi
                kebutuhan
                request kamu.</p>
        </div>
    ...
    <section class="py-60 mt-20 bg-cover bg-center text-white relative" style="background-image: url('image/cs.jpg');">
